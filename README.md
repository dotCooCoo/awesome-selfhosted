...
- [HermitStash](https://hermitstash.com) - Post-quantum encrypted file uploads with ML-KEM-1024 + P-384 hybrid encryption, zero plaintext on disk, vault-sealed database, and admin panel. ([Source Code](https://github.com/dotCooCoo/hermitstash)) `AGPL-3.0` `Docker/Nodejs`
